...
class MainWindow(wx.Frame):
    ...
    def __init__(self, db):
        wx.Frame.__init__(self, None, wx.ID_ANY, wx.GetApp().GetAppDisplayName() + " : " + db.get_directory())
    ...
    def InitGui(self):
        ...
        self._db.add_listener("view-restore", self.OnViewRestore)
        self._db.add_listener("view-save", self.OnViewSave)
...
#            view_window = view(self.views, self._db)
...
#            self.views.AddPage(view_window, view.VIEW_NAME, view_bitmap)
        ...
        self._db.notify_listeners("view-restore")

        # Events
        self.Bind(wx.EVT_CLOSE, self.OnClose)

    def OnClose(self, event):
        self._db.notify_listeners("view-save")
